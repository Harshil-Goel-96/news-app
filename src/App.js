    ...
    <div className="main-container">
      <div className="hero">
        ...
        <div className="hero-para">
          {(!newsArticles.length) ?
            (<p>Try pressing the Hovering Mic button <MicIcon style={{ fontSize: "1rem" }} /> at the bottom of this page
          and ask Alan about the Latest News or about some other stuff.
            </p>) : (<p>Try saying : <span style={{ fontSize: "1.2rem", fontWeight: "bolder" }} > Go back Or Open article number 2</span></p>)}
        </div>
      </div>
      ...
      <div className="footer">
        <p><strong>&copy; Harshil Corp</strong></p>
        <div className="follow-pal">
          <p><strong>Follow : </strong></p>
          <IconButton href="https://www.facebook.com/harshil.goel.60" target="_blank" color="inherit" ><FacebookIcon className="icon" /></IconButton>
          <IconButton href="https://www.twitter.com/harshilgoel96?s=01" target="_blank" color="inherit" ><TwitterIcon className="icon" /></IconButton>
